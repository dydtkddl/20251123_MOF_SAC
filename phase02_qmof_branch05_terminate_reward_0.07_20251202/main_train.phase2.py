...
CMAX_MAX = 0.4         # 후반 EP에서 사용할 최대 cmax
CMAX_SCH_START_EP = 300       # cmax 증가 시작 EP
...
for ep in range(EPOCHS):
    ...
    logger.info(
        f"[EP {ep}] perturb_sigma = {sigma_ep:.4f} Å, max_perturb={MAX_PERTURB:.3f} Å"
    )
